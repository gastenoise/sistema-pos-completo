...
import { applyCategoryCacheUpdate } from '@/modules/settings/utils/settingsTransformers';
...
import { useSettingsCatalogIntegrations } from '@/modules/settings/hooks/useSettingsCatalogIntegrations';
...
export default function Settings() {
  ...
  const updateCategoryCache = (response) => applyCategoryCacheUpdate({ queryClient, businessId, response });
  ...
  const {
    ...
    bankAccount,
    smtpConfig,
  } = useSettingsCatalogIntegrations(businessId);
