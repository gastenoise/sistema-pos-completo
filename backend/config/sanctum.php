...
return [
    ...
    */
    ...
    'stateful' => explode(',', env('SANCTUM_STATEFUL_DOMAINS', sprintf(
        '%s,%s',
        'localhost,localhost:3000,127.0.0.1,127.0.0.1:8000,::1,sistema-pos-completo.vercel.app',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Frontend Idle Session Timeout
    |--------------------------------------------------------------------------
    |
    | Minutes of inactivity before a frontend token is considered expired.
    |
    */
